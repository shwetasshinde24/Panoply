...
int initialize_enclave(void)
{
    ...
    // printf("The eid of newly created enclave is: %d \n", global_eid);
...
int SGX_CDECL main(int argc, char *argv[])
{
    ...
    MyEnclave_ecall_set_parsed_section_info(global_eid, &spret, ".data", 1, sec_data_size);
    MyEnclave_ecall_set_parsed_section_info(global_eid, &spret, ".bss", 0, bss_data_addr);
    MyEnclave_ecall_set_parsed_section_info(global_eid, &spret, ".bss", 1, bss_data_size);
    ...
    // printf("Info: SampleEnclave successfully returned. of global: %d \n", global_eid);
    // printf("Enter a character before exit ...\n");
