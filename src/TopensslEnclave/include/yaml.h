...
YAML_DECLARE(void)
yaml_parser_set_input_file(yaml_parser_t *parser, SGX_WRAPPER_FILE file);
...
YAML_DECLARE(void)
yaml_emitter_set_output_file(yaml_emitter_t *emitter, SGX_WRAPPER_FILE file);
