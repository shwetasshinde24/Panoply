...
tds_set_column_type(TDSCONNECTION * conn, TDSCOLUMN * curcol, int type)
{
	...
	curcol->funcs = (TDSCOLUMNFUNCS *)tds_get_column_funcs(conn, type);
...
const TDSCOLUMNFUNCS tds_clrudt_funcs = { 
	...
	&tds_clrudt_get,
	&tds_clrudt_row_len,
	&tds_clrudt_put_info_len,
	&tds_clrudt_put_info,
	&tds_clrudt_put	
};
const TDSCOLUMNFUNCS tds_variant_funcs = { 
	&tds_variant_get_info, 
	&tds_variant_get,
	&tds_variant_row_len,
	&tds_variant_put_info_len,
