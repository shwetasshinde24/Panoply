...
static SGX_WRAPPER_FILE f = NULL;
...
int
ecall_unittest_readconf_main(int argc, char **argv)
{
	const char *in_file = "/home/kekkaishi/Desktop/EnclaveCode/freetdsexperiment/src/TdsEnclave/tds/unittest/readconf.in";
	...
	fclose(f);
	fprintf(stdout, "Pass the readconf test \n");
	return 0;
}
