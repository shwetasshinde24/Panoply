...
// {
//   struct msg *tmp;
//   if ((tmp = (struct msg *)malloc(sizeof(struct msg))) == NULL) {
...
// {
//   struct kill *tmp;
//   if ((tmp = (struct kill *)malloc(sizeof(struct kill))) == NULL) {
//     event_warn("%s: malloc", __func__);
//     return (NULL);
//   }
...
// {
//   struct run *tmp;
//   if ((tmp = (struct run *)malloc(sizeof(struct run))) == NULL) {
//     event_warn("%s: malloc", __func__);
//     return (NULL);
//   }
//   tmp->base = &__run_base;
...
//   msg->some_bytes_data = (uint8_t*)malloc(len);
//   if (msg->some_bytes_data == NULL)
//     return (-1);
...
//           return (-1);
//         if ((tmp->some_bytes_data = (uint8_t*)malloc(tmp->some_bytes_length)) == NULL)
//           return (-1);
