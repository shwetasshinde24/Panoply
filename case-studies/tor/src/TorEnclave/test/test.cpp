...
//  { "", test_array },
  // { "buffer/", buffer_tests },  // PASS
  // { "socks/", socks_tests },    // PASS
//  { "addr/", addr_tests },    // Not pass
  // { "crypto/", crypto_tests },  // PASS
  // { "container/", container_tests },  // PASS
  { "util/", util_tests },  // Need to add background spawn 
  { "util/logging/", logging_tests }, // PASS
  // { "cellfmt/", cell_format_tests },  // PASS
 // { "cellqueue/", cell_queue_tests },  // PASS
  // { "dir/", dir_tests }, // Fail 1 unit test
  // { "dir/md/", microdesc_tests }, // PASS
 // { "pt/", pt_tests }, // PASS only when run seperated unit test, bug in counting event transports.cpp 386
 //  { "config/", config_tests }, // PASS
  // { "replaycache/", replaycache_tests },  // PASS
  // { "relaycell/", relaycell_tests },  // PASS
  // { "introduce/", introduce_tests },  // PASS
  // { "circuitlist/", circuitlist_tests },  // PASS
  // { "circuitmux/", circuitmux_tests },  // PASS
  // { "options/", options_tests }, // Bug in config_dup
  // { "extorport/", extorport_tests },  // PASS
  // { "control/", controller_event_tests }, // PASS
  // { "hs/", hs_tests },  // PASS
  // { "nodelist/", nodelist_tests },  // PASS
  // { "routerkeys/", routerkeys_tests },  // PASS
  // { "oom/", oom_tests },  // PASS
  // { "policy/" , policy_tests }, // PASS
  // { "status/" , status_tests }, // PASS
  END_OF_GROUPS
};
 ...
 * some unit tests. */
int
ecall_test_test_main(int c, char **v)
{
