...
test_util_fgets_eagain(void *ptr)
{
  ...
  ssize_t retlen;
  char *retptr;
  SGX_WRAPPER_FILE *test_stream = NULL;
  char buf[10];
...
struct testcase_t util_tests[] = {
  UTIL_LEGACY(time),  // PASS
  UTIL_TEST(parse_http_time, 0),  // PASS
  UTIL_LEGACY(config_line),  // PASS
  UTIL_LEGACY(config_line_quotes),  // PASS
  UTIL_LEGACY(config_line_comment_character),  // PASS
  UTIL_LEGACY(config_line_escaped_content),  // PASS
#ifndef _WIN32
 UTIL_LEGACY(expand_filename),  // PASS
#endif
  UTIL_LEGACY(escape_string_socks),  // PASS
  UTIL_LEGACY(string_is_key_value),  // PASS
  UTIL_LEGACY(strmisc),  // PASS
  UTIL_LEGACY(pow2),  // PASS
  UTIL_LEGACY(gzip),  // PASS
  UTIL_LEGACY(datadir), // PASS
#ifdef ENABLE_MEMPOOLS
  // UTIL_LEGACY(mempool),  // PASS
#endif
  UTIL_LEGACY(memarea),  // PASS
  UTIL_LEGACY(control_formats), // PASS
  UTIL_LEGACY(threads), // PASS
  UTIL_LEGACY(sscanf), // PASS
  UTIL_LEGACY(path_is_relative), // PASS
  UTIL_LEGACY(strtok), // PASS
  UTIL_LEGACY(di_ops), // PASS
  UTIL_TEST(round_to_next_multiple_of, 0), // PASS
  UTIL_TEST(strclear, 0), // PASS
  UTIL_TEST(find_str_at_start_of_line, 0), // PASS
  UTIL_TEST(string_is_C_identifier, 0), // PASS
  UTIL_TEST(asprintf, 0),  // PASS
  UTIL_TEST(listdir, 0),  // PASS
  UTIL_TEST(parent_dir, 0),  // PASS
#ifdef _WIN32
  // UTIL_TEST(load_win_lib, 0),  // PASS
#endif
#ifndef _WIN32
  UTIL_TEST(exit_status, 0),  // PASS
  UTIL_TEST(fgets_eagain, TT_SKIP),  // PASS
#endif
  ...
  UTIL_TEST(read_file_eof_tiny_limit, 0),  // PASS
  UTIL_TEST(read_file_eof_two_loops, 0),  // PASS
  UTIL_TEST(read_file_eof_zero_bytes, 0),  // PASS
  UTIL_TEST(write_chunks_to_file, 0), // PASS
  UTIL_LEGACY(mmap),  // PASS
  UTIL_TEST(format_hex_number, 0),  // PASS
  UTIL_TEST(format_dec_number, 0),  // PASS
  UTIL_TEST(join_win_cmdline, 0),  // PASS
  UTIL_TEST(split_lines, 0),  // PASS
  UTIL_TEST(n_bits_set, 0),  // PASS
  UTIL_TEST(eat_whitespace, 0),  // PASS
  UTIL_TEST(sl_new_from_text_lines, 0),  // PASS
  UTIL_TEST(envnames, 0),  // PASS
  UTIL_TEST(make_environment, 0),  // PASS
  UTIL_TEST(set_env_var_in_sl, 0),  // PASS
  UTIL_TEST(mathlog, 0),  // PASS
  UTIL_TEST(weak_random, 0),  // PASS
  UTIL_TEST(socket, TT_FORK),  // PASS
  { "socketpair", test_util_socketpair, TT_FORK, &socketpair_setup,
    (void*)"0" },  // PASS
  { "socketpair_ersatz", test_util_socketpair, TT_FORK,
    &socketpair_setup, (void*)"1" },  // PASS
  UTIL_TEST(max_mem, 0),  // PASS
  END_OF_TESTCASES
};
