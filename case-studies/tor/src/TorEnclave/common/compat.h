...
#ifndef HAVE_STRLCAT
extern size_t strlcat(char *dst, const char *src, size_t siz) ATTR_NONNULL((1,2));
#endif
#ifndef HAVE_STRLCPY
extern size_t strlcpy(char *dst, const char *src, size_t siz) ATTR_NONNULL((1,2));
#endif
...
// #define tor_asprintf(A, B, ...) sgx_wrapper_asprintf(A, B, ##__VA_ARGS__)
...
SGX_WRAPPER_FILE tor_fopen_cloexec(const char *path, const char *mode);
