                  ...
                  compress_method_t method)
{
  ...
  *out = NULL;
  ...
  stream = (struct z_stream_s *)tor_malloc_zero(sizeof(struct z_stream_s));
  ...
  while (1) {
    switch (deflate(stream, Z_FINISH))
      ...
      case Z_BUF_ERROR:
        ...
        *out = (char *)tor_realloc(*out, out_size);
  ...
  *out_len = stream->total_out;
  ...
  if (((size_t)stream->total_out) > out_size + 4097) {
    ...
    *out = (char *)tor_realloc(*out, stream->total_out + 1);
  }
                    ...
                    int protocol_warn_level)
{
  ...
  *out_len = stream->next_out - (unsigned char*)*out;
  ...
  if (out_size == *out_len)
    *out = (char *)tor_realloc(*out, out_size + 1);
  (*out)[*out_len] = '\0';
...
tor_zlib_new(int compress, compress_method_t method)
{
 ...
 out = (tor_zlib_state_t *)tor_malloc_zero(sizeof(tor_zlib_state_t));
