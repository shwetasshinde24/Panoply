...
circuitmux_alloc(void)
{
  ...
  rv = (circuitmux_t *)tor_malloc_zero(sizeof(*rv));
  rv->chanid_circid_map = (chanid_circid_muxinfo_map_t *)tor_malloc_zero(sizeof(*( rv->chanid_circid_map)));
                           ...
                           cell_direction_t direction))
{
  ...
  if (hashent) {
    ...
    hashent = (chanid_circid_muxinfo_t *)tor_malloc_zero(sizeof(*hashent));
...
circuitmux_detach_circuit,(circuitmux_t *cmux, circuit_t *circ))
{
   ...
   */
  cell_direction_t last_searched_direction = (cell_direction_t)0;
