...
struct microdesc_map { 
    struct microdesc_t **hth_table; 
...
get_microdesc_cache(void)
{
  if (PREDICT_UNLIKELY(the_microdesc_cache==NULL)) {
    microdesc_cache_t *cache = (microdesc_cache_t *)tor_malloc_zero(sizeof(microdesc_cache_t));
