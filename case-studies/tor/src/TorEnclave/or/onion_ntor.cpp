                       ...
                       uint8_t *onion_skin_out)
{
  ...
  state = (ntor_handshake_state_t *)tor_malloc_zero(sizeof(ntor_handshake_state_t));
                                 ...
                                 size_t key_out_len)
{
  ...
  keypair_bB = (const curve25519_keypair_t*)dimap_search(private_keys, onion_skin + DIGEST_LEN,
                            (void*)junk_keys);
  if (!keypair_bB)
    return -1;
