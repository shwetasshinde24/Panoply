                          ...
                          networkstatus_t *v3_ns)
{
  ...
  voter = (networkstatus_voter_info_t *)smartlist_get(v3_ns->voters, 0);
...
get_voter(const networkstatus_t *vote)
{
  ...
  return (networkstatus_voter_info_t *)smartlist_get(vote->voters, 0);
}
...
{
  const networkstatus_t *a = (const networkstatus_t *)*_a, *b = (const networkstatus_t *)*_b;
...
{
  const dir_src_ent_t *a = (const dir_src_ent_t *)*_a, *b = (const dir_src_ent_t *)*_b;
...
{
  const tor_addr_port_t *a = (const tor_addr_port_t *)*_a, *b = (const tor_addr_port_t *)*_b;
  int r;
                               ...
                               tor_addr_port_t *best_alt_orport_out)
{
  ...
  if (consensus_method >= MIN_METHOD_FOR_A_LINES && best_alt_orport_out) {
    ...
    most_alt_orport = (tor_addr_port_t *)smartlist_get_most_frequent(alt_orports,
                                                  compare_orports_);
    if (most_alt_orport) {
  ...
  if (consensus_method >= MIN_METHOD_FOR_MICRODESC &&
    ...
    best_microdesc_digest = (char *)smartlist_get_most_frequent_digest256(digests);
...
compute_consensus_method(smartlist_t *votes)
{
  ...
  if (n_ok) {
    const char *best = (const char *)smartlist_get(acceptable_methods, n_ok-1);
...
dirvote_compute_params(smartlist_t *votes, int method, int total_authorities)
{
  ...
  vals = (int32_t *)tor_malloc(sizeof(int)*n_votes);
  ...
  i = 0;
  cur_param = (const char *)smartlist_get(param_list, 0);
  eq = strchr(cur_param, '=');
  tor_assert(eq);
  ...
  SMARTLIST_FOREACH_BEGIN(param_list, const char *, param) {
    ...
    if (param_sl_idx+1 == smartlist_len(param_list))
      ...
      next_param = (const char *)smartlist_get(param_list, param_sl_idx+1);
    if (!next_param || strncmp(next_param, param, cur_param_len)) {
      ...
      if (method < MIN_METHOD_FOR_MAJORITY_PARAMS ||
        ...
        char *out_string = (char *)tor_malloc(64+cur_param_len);
...
{
  bw_weights_error_t berr = (bw_weights_error_t)0;
  int64_t Wgg = -1, Wgd = -1;
                                ...
                                consensus_flavor_t flavor)
{
  ...
  flavor_name = networkstatus_get_flavor_name((consensus_flavor_t)flavor);
   ...
   * routers we might need to talk about. */
  {
    ...
    time_t *va_times = (time_t *)tor_malloc(n_votes * sizeof(time_t));
    time_t *fu_times = (time_t *)tor_malloc(n_votes * sizeof(time_t));
    time_t *vu_times = (time_t *)tor_malloc(n_votes * sizeof(time_t));
    int *votesec_list = (int *)tor_malloc(n_votes * sizeof(int));
    int *distsec_list = (int *)tor_malloc(n_votes * sizeof(int));
  ...
  /* Add the authority sections. */
  {
    ...
    SMARTLIST_FOREACH_BEGIN(votes, networkstatus_t *, v) {
      dir_src_ent_t *e = (dir_src_ent_t *)tor_malloc_zero(sizeof(dir_src_ent_t));
      e->v = v;
      ...
      if (consensus_method >= 3 &&
        ...
        dir_src_ent_t *e_legacy = (dir_src_ent_t *)tor_malloc_zero(sizeof(dir_src_ent_t));
        e_legacy->v = v;
  ...
  if (consensus_method >= MIN_METHOD_TO_CLIP_UNMEASURED_BW) {
    ...
    if (params) {
      if (strcmpstart(params, "maxunmeasuredbw=") == 0)
        ...
        max_unmeasured_param = (char *)strstr(params, " maxunmeasuredbw=");
    }
  ...
  /* Add the actual router entries. */
  {
    ...
    uint32_t *bandwidths_kb = (uint32_t *)tor_malloc(sizeof(uint32_t) *
                                         smartlist_len(votes));
    uint32_t *measured_bws_kb = (uint32_t *)tor_malloc(sizeof(uint32_t) *
                                           smartlist_len(votes));
    int num_bandwidths;
    int num_mbws;
    ...
    index = (int *)tor_malloc_zero(sizeof(int)*smartlist_len(votes));
    size = (int *)tor_malloc_zero(sizeof(int)*smartlist_len(votes));
    n_voter_flags = (int *)tor_malloc_zero(sizeof(int) * smartlist_len(votes));
    n_flag_voters = (int *)tor_malloc_zero(sizeof(int) * smartlist_len(flags));
    flag_map = (int **)tor_malloc_zero(sizeof(int*) * smartlist_len(votes));
    named_flag = (int *)tor_malloc_zero(sizeof(int) * smartlist_len(votes));
    unnamed_flag = (int *)tor_malloc_zero(sizeof(int) * smartlist_len(votes));
     ...
     * them.*/
    SMARTLIST_FOREACH_BEGIN(votes, networkstatus_t *, v) {
      flag_map[v_sl_idx] = (int *)tor_malloc_zero(
    ...
    if (consensus_method >= 2) {
      SMARTLIST_FOREACH_BEGIN(votes, networkstatus_t *, v) {
        ...
        SMARTLIST_FOREACH_BEGIN(v->routerstatus_list,
          ...
          if ((rs->flags & nf) != 0) {
            const char *d = (const char *)strmap_get_lc(name_to_id_map, rs->status.nickname);
            if (!d) {
    ...
    flag_counts = (int *)tor_malloc(sizeof(int) * smartlist_len(flags));
    while (1) {
      vote_routerstatus_t *rs;
      ...
      SMARTLIST_FOREACH(votes, networkstatus_t *, v, {
        if (index[v_sl_idx] < size[v_sl_idx]) {
          rs = (vote_routerstatus_t *)smartlist_get(v->routerstatus_list, index[v_sl_idx]);
          if (!lowest_id ||
      ...
      if (consensus_method == 1) {
        ...
        const char *d = (const char *)strmap_get_lc(name_to_id_map, rs_out.nickname);
        if (!d) {
  ...
  if (consensus_method >= MIN_METHOD_FOR_BW_WEIGHTS) {
    ...
    if (params) {
      if (strcmpstart(params, "bwweightscale=") == 0)
        ...
        bw_weight_param = (char *)strstr(params, " bwweightscale=");
    }
                                      ...
                                      const char **msg_out)
{
  ...
  siglist = (smartlist_t *)strmap_get(sigs->signatures, flavor);
  if (!siglist) {
  ...
  {
    digests_t *digests = (digests_t *)strmap_get(sigs->digests, flavor);
    int n_matches = 0;
    int alg;
    if (!digests) {
...
{
  authority_cert_t *out = (authority_cert_t *)tor_malloc(sizeof(authority_cert_t));
  tor_assert(cert);
...
dirvote_fetch_missing_votes(void)
{
  ...
  SMARTLIST_FOREACH_BEGIN(router_get_trusted_dir_servers(),
      ...
      if (!dirvote_get_vote(ds->v3_identity_digest,
        ...
        char *cp = (char *)tor_malloc(HEX_DIGEST_LEN+1);
...
dirvote_add_vote(const char *vote_body, const char **msg_out, int *status_out)
{
 ...
 again:
  ...
  pending_vote = (pending_vote_t *)tor_malloc_zero(sizeof(pending_vote_t));
...
dirvote_compute_consensuses(void)
{
  ...
  SMARTLIST_FOREACH(pending_vote_list, pending_vote_t *, v,
    {
      sized_chunk_t *c = (sized_chunk_t *)tor_malloc(sizeof(sized_chunk_t));
...

  {
    ...
    for (flav = 0; flav < N_CONSENSUS_FLAVORS; ++flav) {
      const char *flavor_name = networkstatus_get_flavor_name((consensus_flavor_t)flav);
                       ...
                       const char **msg_out)
{
  ...
  *msg_out = NULL;
  ...
  {
    smartlist_t *sig_list = (smartlist_t *)strmap_get(sigs->signatures, flavor_name);
  ...
  if (r >= 1) {
    ...
    pc->body = (char *)tor_realloc(pc->body, new_consensus_len);
    dst_end = pc->body + new_consensus_len;
    dst = (char *)strstr(pc->body, "directory-signature ");
    tor_assert(dst);
...
dirvote_publish_consensus(void)
{
  ...
  for (i = 0; i < N_CONSENSUS_FLAVORS; ++i) {
    ...
    const char *name;
    name = networkstatus_get_flavor_name((consensus_flavor_t)i);
    tor_assert(name);
...
dirvote_create_microdescriptor(const routerinfo_t *ri, int consensus_method)
{
...

  {
    ...
    result = (microdesc_t *)smartlist_get(lst, 0);
    smartlist_free(lst);
  }
                                        ...
                                        smartlist_t *microdescriptors_out)
{
  ...
  for (cmr = microdesc_consensus_methods;
    ...
    if (md) {
      microdesc_vote_line_t *e = (microdesc_vote_line_t *)
  ...
  while ((ep = entries)) {
    ...
    dirvote_format_microdesc_vote_line(buf, sizeof(buf), ep->md,
                                       ep->low, ep->high);
    h = (vote_microdesc_hash_t *)tor_malloc_zero(sizeof(vote_microdesc_hash_t));
