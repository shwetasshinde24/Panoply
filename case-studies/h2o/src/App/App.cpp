...
int SGX_CDECL main(int argc, char *argv[])
{
    ...
    // printf("H2o enclave id is: %d \n", global_eid);
    ret = H2oEnclave_ecall_set_enclave_id(global_eid, global_eid);
    if (ret != SGX_SUCCESS)
        abort();

    ret = H2oEnclave_ecall_h2o_main(global_eid, &ecall_return, argc, argv);
    if (ret != SGX_SUCCESS)
        abort();
    ...
    //         //     printf("H2oEnclave_ecall_h2o_main: %d \n", parent_eid);
    //         //     ret = H2oEnclave_ecall_h2o_main(parent_eid, &ecall_return, argc, argv); 
    //         //     if (ret != SGX_SUCCESS) {
