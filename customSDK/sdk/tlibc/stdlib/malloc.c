...
#ifdef _TLIBC_
const void* malloc_mparams_ptr = &mparams;
const void* malloc_gm_ptr = &_gm_;
const size_t mstate_size = sizeof(struct malloc_state);
const size_t mparam_size = sizeof(struct malloc_params);
#endif
