...
static sgx_status_t SGX_CDECL Enclave1_session_request_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_exchange_report_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_send_request_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_end_session_ocall(void* pms)
{
...
static const struct {
	...
	9,
	{
		(void*)Enclave1_session_request_ocall,
		(void*)Enclave1_exchange_report_ocall,
		(void*)Enclave1_send_request_ocall,
		(void*)Enclave1_end_session_ocall,
		(void*)Enclave1_sgx_oc_cpuidex,
		(void*)Enclave1_sgx_thread_wait_untrusted_event_ocall,
		(void*)Enclave1_sgx_thread_set_untrusted_event_ocall,
		(void*)Enclave1_sgx_thread_setwait_untrusted_events_ocall,
		(void*)Enclave1_sgx_thread_set_multiple_untrusted_events_ocall,
	}
};
