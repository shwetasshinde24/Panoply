...
#else
#define STDIN_HANDLE SGX_WRAPPER_FILE
#endif
...
struct testcase_t pt_tests[] = {
  PT_LEGACY(parsing), // PASS
  PT_LEGACY(protocol), // PASS
  { "get_transport_options", test_pt_get_transport_options, 0,
    NULL, NULL }, 
  { "get_extrainfo_string", test_pt_get_extrainfo_string, 0,
    NULL, NULL },  // PASS
