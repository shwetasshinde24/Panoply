...
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write0, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write1, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write2, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write3, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write4, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write5, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write6, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write7, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write8, (void* buffer, int bufsiz));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write9, (void* buffer, int bufsiz));
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_context_switch, (int dummy1, int dummy2));
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_dummy_clone_process, ());
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_fork, (void* buffer, int bufsiz));
